...
export const MODULE_ACCORDIONITEM_FRAGMENT = /* GraphQL */ `
...
export const MODULE_PARALLAX_FRAGMENT = /* GraphQL */ `
    ... on modules_parallax_BlockType {
        ${BASE_MODULE_FRAGMENT}
        headline: textPlain
        image {
            ${IMAGE_FRAGMENT}
...
export const MODULE_CODE_FRAGMENT = /* GraphQL */ `
    ... on modules_code_BlockType {
        ${BASE_MODULE_FRAGMENT}
        code: textHTML
    }
`;
