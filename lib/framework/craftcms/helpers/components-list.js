...
export default {
    ...
    modules_parallax_blocktype: dynamic(() => import('@/components/organisms/Parallax/Parallax')),
    modules_code_blocktype: dynamic(() => import('@/components/organisms/Code')),
    modules_accordion_blocktype: dynamic(() => import('@/components/organisms/Accordion/Accordion')),
    modules_accordionitem_blocktype: dynamic(() => import('@/components/organisms/Accordion/AccordionItem')),
};
